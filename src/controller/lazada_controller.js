...
const createProductLazada = async (req, res) => {
    try {
        ...
        // Hitung Net_Weight
        const beratGram = attributes.Net_Weight
            ? Number(attributes.Net_Weight)
            : Math.round((stokTerpilih.berat || 0.02) * 1000); // default konversi kg -> g
            ...
            Request: {
                Product: {
                    ...
                    Attributes: {
                        ...
                        Net_Weight: beratGram, // angka saja untuk Attributes
                    },
                    Skus: {
                        Sku: [
                            {
                                ...
                                Net_Weight: `${beratGram} g`, // string dengan satuan untuk SKU
                            },
                        ],
                    },
                },
